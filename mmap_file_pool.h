...
public:
		...
		void open_and_mmap_file(std::string fname, enum access_mode access_mode, off_t offset, size_t length);
...
public:
		...
		void *mmap_file(std::string fname, enum access_mode access_mode, off_t offset, size_t length);
